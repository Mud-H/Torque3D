...
new GuiControlProfile( GuiHighlightMenuButtonProfile )
{
   ...
   justify = "center";
   canKeyFocus = false;
   bitmap = "data/art/gui/selector-button-highlight-only";
   hasBitmapArray = false;
   category = "Core";
};
...
new GuiControlProfile( GuiGroupBorderProfile )
{
   ...
   opaque = false;
   hasBitmapArray = true;
   bitmap = "data/art/gui/group-border";
   category = "Core";
};
...
new GuiControlProfile( GuiTabBorderProfile )
{
   ...
   opaque = false;
   hasBitmapArray = true;
   bitmap = "data/art/gui/tab-border";
   category = "Core";
};
...
new GuiControlProfile( GuiRadioProfile )
{
   ...
   fixedExtent = true;
   bitmap = "data/art/gui/radioButton";
   hasBitmapArray = true;
   category = "Core";
};
